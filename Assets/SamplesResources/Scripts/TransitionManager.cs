...
public class TransitionManager : MonoBehaviour
{
    ...
    private MixedRealityController.Mode GetMixedRealityMode()
    {
        if (InAR)
        {
            return ModeConfig.isFullScreenMode ?
                MixedRealityController.Mode.HANDHELD_AR : MixedRealityController.Mode.HANDHELD_AR; //: MixedRealityController.Mode.VIEWER_AR;
        }
        else // in VR
        {
            return ModeConfig.isFullScreenMode ?
                MixedRealityController.Mode.HANDHELD_VR : MixedRealityController.Mode.HANDHELD_VR; //: MixedRealityController.Mode.VIEWER_VR;
        }
    }
    ...
    private void UpdateVisibleObjects()
    {
        ...
        // Disable animations for AR mode
        /*
        if (m_Astronaut != null)
        {
        ...
        */
        ...
        if (!InAR)
        {
            // Toggle mesh collider state to enable collisions
            if (m_MeshCol != null)
            {
    ...
    {
        var bgPlaneBehaviour = GetCameraRigRoot().GetComponentInChildren<BackgroundPlaneBehaviour>();
